...
services:
  iac-portal:
    ...
    image: "${DOCKER_REGISTRY}cloudiac/iac-portal:v0.9.0-rc3"
    volumes:
      - type: bind
  ...
  ct-runner:
    ...
    image: "${DOCKER_REGISTRY}cloudiac/ct-runner:v0.9.0-rc3"
    volumes:
      - type: bind
        source: /usr/yunji/cloudiac/var
        target: /usr/yunji/cloudiac/var
  ...
  iac-web:
    ...
    image: "${DOCKER_REGISTRY}cloudiac/iac-web:v0.9.0-rc3"
    ports:
      - 80:80
    restart: always
    depends_on:
